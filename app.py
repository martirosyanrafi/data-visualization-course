...
@app.callback(filter.get_output('state'), filter.get_inputs('state'))
def update_output(brand, color, state, year, price):
    return st.get_output_content(filter.get_df(df, brand, color, state, year, price))
